...
class CustListAdapter(val context: Activity ,val listOfStocks : List<StockInfo>): ArrayAdapter<StockInfo>(
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        layoutParams.setMargins( context.resources.getDimensionPixelSize(R.dimen.margin_between_cards),
                context.resources.getDimensionPixelSize(R.dimen.margin_between_cards)
            , context.resources.getDimensionPixelSize(R.dimen.margin_between_cards),
            context.resources.getDimensionPixelSize(R.dimen.margin_between_cards))
